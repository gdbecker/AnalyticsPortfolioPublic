...
function Navigation() {
  ...
  return (
    <div className="flex h-16 p-10 items-center justify-between overflow-hidden border-lightGray border-b-2 bg-gray 2xl:px-36">
      ...
      <a className="flex items-center justify-center" href="https://github.com/gdbecker/AnalyticsPortfolio/tree/main" target="_blank">
        <Image 
          src={Avatar}
          alt="Profile Photo"
